                            ...
                            <form action="{{url('update-taxes')}}" method="post" class="tax-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control sgst" name="sgst" value="{{$setting->sgst}}" min="0" max="30" required>
                                ...
                                <div class="form-group">
                                    <label>CGST</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control cgst" name="cgst" value="{{$setting->cgst}}" min="0" max="30" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>TDS</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="tds" value="{{$setting->tds}}" minlength="1" maxlength="7" 

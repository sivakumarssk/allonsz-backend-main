                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" data-id="{{$user->id}}" data-first_name="{{$user->first_name}}" data-last_name="{{$user->last_name}}" data-email="{{$user->email}}" data-phone="{{$user->phone}}" data-gender="{{$user->gender}}" 
                      data-country="{{$user->country_id}}" data-state="{{$user->state_id}}" data-district="{{$user->district_id}}" data-mandal="{{$user->mandal_id}}"><i class="fa fa-edit"></i></button>
                      @if($user->status == 'Pending')
                      <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal" data-id="{{$user->id}}" data-action="permanent"><i class="fa fa-trash"></i></button>
                      @endif
                    </td>

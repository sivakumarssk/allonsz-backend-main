            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(url('update-cancellation-policy')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <label>Return and Refund Policy</label>
                                    <textarea name="cancellation_policy" id="summernote" class="form-control"><?php echo $cancellation_policy; ?></textarea>
                                </div>
                                <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\allonsz-backend-main\resources\views/admin/settings/cancellation_policy.blade.php ENDPATH**/ ?>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;text-align: center;">
    <div style="max-width: 600px; background: white; padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px #ccc; margin: 0 auto; text-align: center;">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <img src="<?php echo e($logo); ?>" alt="<?php echo e($bussiness_name); ?>" style="width: 160px; display: block; margin: 0 auto;">
            <span style="display: block; color: white;"><?php echo e($bussiness_name); ?></span>
        </div>
        ...
        <br>
        <p style="font-size: 16px; color: #888;">Email or contact <span style="color: #333;"><?php echo e($email_support); ?></span></p>
        <p style="font-size: 16px; color: #333;"><span style="color: #2d89ef;">Privacy policy</span></p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\allonsz-backend-main\resources\views/email/forget_password2.blade.php ENDPATH**/ ?>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(url('/')); ?>">
        <center>
            <img src="<?php echo e($setting->logo); ?>" alt="AdminLTE Logo" class="brand-image" style="width:200px;height:200px;">
        </center>
    </a>
    <?php $user = Auth::User(); ?>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('customer-timers')); ?>" class="nav-link <?php echo e(request()->is('customer-timers*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Timers</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(url('withdraws')); ?>" class="nav-link <?php echo e(request()->is('withdraws*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Withdraw Request</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('trip.index')); ?>" class="nav-link <?php echo e(request()->is('trip*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Trips</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('country.index')); ?>" class="nav-link <?php echo e(request()->is('country*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Country</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('state.index')); ?>" class="nav-link <?php echo e(request()->is('state*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>State</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('mandal.index')); ?>" class="nav-link <?php echo e(request()->is('mandal*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Mandal</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('tour.index')); ?>" class="nav-link <?php echo e(request()->is('tour*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Tour</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('package.index')); ?>" class="nav-link <?php echo e(request()->is('package*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Package</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(url('add')); ?>" class="nav-link <?php echo e(request()->is('add*') ? 'active' : ''); ?>">
          ...
          <!--</li>-->
          <li class="nav-item">
            <a href="<?php echo e(route('order.index')); ?>" class="nav-link <?php echo e(request()->is('order*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-solid fa-wrench"></i>
              <p>Orders</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('subscription.index')); ?>" class="nav-link <?php echo e(request()->is('subscription*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-solid fa-wrench"></i>
              <p>Subscriptions</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('transaction.index')); ?>" class="nav-link <?php echo e(request()->is('transaction*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-solid fa-wrench"></i>
              <p>Transactions</p>
            </a>
          </li>
...
<?php /**PATH C:\xampp\htdocs\allonsz-backend-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
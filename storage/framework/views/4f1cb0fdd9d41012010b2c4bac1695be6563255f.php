            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo e($i); ?></td>
                    <td><?php echo e($withdraw->request_code); ?></td>
                    <td><a href="<?php echo e(url('/show-customer',$withdraw->user_id)); ?>" target="_blank"><?php echo e($withdraw->user->name); ?></a></td>
                    <td><?php echo e($withdraw->amount); ?></td>
                    <td><?php echo e($withdraw->transfer_details); ?></td>
                    <td><?php echo e($withdraw->status); ?></td>
                    <td><?php echo e($withdraw->created_at); ?></td>
                    <td><?php echo e($withdraw->updated_at); ?></td>
                    <td>
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" data-id="<?php echo e($withdraw->id); ?>" data-name="<?php echo e($withdraw->user->name); ?>" data-user_id="<?php echo e($withdraw->user_id); ?>"
                      data-amount="<?php echo e($withdraw->amount); ?>" data-transfer_details="<?php echo e($withdraw->transfer_details); ?>" data-status="<?php echo e($withdraw->status); ?>"><i class="fa fa-edit"></i></button>
                    </td>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo e(url('/update-withdraw')); ?>" method="post" class="add-form">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\allonsz-backend-main\resources\views/admin/withdraws.blade.php ENDPATH**/ ?>